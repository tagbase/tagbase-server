...
class ErrorContainer(Model):
    ...
    def errors(self, errors):
        ...
        if errors is not None and len(errors) > 100:
            raise ValueError("Invalid value for `errors`, number of items must be less than or equal to `100`")  # noqa: E501
        if errors is not None and len(errors) < 0:
            raise ValueError("Invalid value for `errors`, number of items must be greater than or equal to `0`")  # noqa: E501

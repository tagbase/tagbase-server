...
COPY metadata_types (attribute_id, category, attribute_name, description, example, comments, necessity) FROM stdin;
1	instrument	instrument_name	Append an identifier that is unique within your organization. This is essential if a device is recycled.	16P0100-Refurb2	Devices might be reused, so the serial number will be the same. The only way to distinguish is by providing a unique name for the recycled product. 	required
...
3	instrument	firmware	Version number of the firmware used to build the device	\N	\N	required
4	instrument	manufacturer	Name of manufacturer	Wildlife Computers, Microwave Telemetry, Lotek Wireless, Desert Star Systems, CEFAS, StarOddi, Sea Mammal Research Unit, Vemco, Loggerhead Instruments, Biologging Solutions, Little Leonardo, Teleonics etc.	\N	required
5	instrument	model	Model name	MiniPAT	\N	required
6	instrument	owner_contact	Contact email/ telephone/ address	\N	\N	required
7	instrument	person_owner	Researcher/ organization owning the device	\N	PI/scientist/organization is used interchangeably here. But best to have a first-last name specified here.	required
8	instrument	serial_number	Serial number	16P0100	\N	required
...
10	instrument	project	Name or identifer for project/ grant number	\N	\N	recommended
11	instrument	ptt	Platform Transmitting Terminal (PTT) number for Argos transmission.	\N	\N	recommended
12	instrument	ptt_hex	PTT in hexadecimal	\N	\N	recommended
13	instrument	specs	Specification document name/ URL/ file (e.g., in xml)	\N	Need input from manufacturer. May allow attachment or upload. Or grab it from an online archive.	recommended
14	instrument	code_map	Placeholder for acoustic tags	\N	Refer to ATN spec.	no
15	instrument	ping_code	Placeholder for acoustic tags	\N	Refer to ATN spec.	no
100	programming	programming_report	File/ URL to a report listing the details of programming	\N	Need input from manufacturer. May allow attachment or upload. Or grab it from an online archive.	required
101	programming	programming_software	Programming software with version number	\N	\N	required
...
103	programming	days_mission	Programmed mission length in days	365	\N	recommended
...
105	programming	person_programmer	Person responsible for the programming	\N	\N	recommended
...
108	programming	seconds_sampling_highfreq	Sampling rate (seconds) for sensor sampling at a higher frequency	\N	For sensors that sample in Hertz (Hz),  e.g., accelerometer, magnetometer	optional
200	attachment	attachment_method	Method used to put the tag on/ in the animal	tow, glue, suction, anchor, mount, implant, harness, backpack	Should be restricted to the examples provided. Tow includes tethered for popup or towed for satellite tags . Glue is using adhesive or epoxy. Mount is using screw, bolt, button, sleeve or backpack. Anchor is equivalent to applying a conventional tag or using a gun (air, spear etc.). Implant implies surgery, ingestion or insertion.	required
...
202	attachment	anchor_dimensions_mm	Dimensions (millimeter) as length, width, thickness or diameter.	20 L x 14 W	Can be used loosely as size: small, medium and large.	recommended
203	attachment	anchor_material	Material of anchor	nylon, urethane, stainless steel, titanium	\N	recommended
204	attachment	anchor_type	Type of anchor	Domeier, Wilton, Titanium	\N	recommended
205	attachment	attachment_product	Brand name and/ product for attachment materials used	VetBond, Peel Ply, tesaÃƒâ€šÃ‚Â®	Brand and product name of suture, stainless steel wire, monofilament, bolt, tape, adhesive, epoxy, suction cup, air gun, speargun, pole, applicator and tip.	recommended
206	attachment	mount_type	Type of mount	Fin, tail, carapacial ridge	\N	recommended
207	attachment	release_method	Method to get a tag detached from the animal/ anchor	corrosive burn wire, oxidative/ explosive, galvanizing metal, acoustic release	\N	recommended
...
209	attachment	tether_length_cm	End to end length (centimeter) of a tether	\N	\N	recommended
...
211	attachment	anesthetic_product	Brand name and/ product of anesthesia used during the attachment	metomidate, Aqua-S	\N	optional
212	attachment	antifouling_product	Brand name and/ product of antifouling paint or coating applied 	PropSpeed	\N	optional
213	attachment	antiseptic_product	Brand name and/ product of antiseptic or sterilizing agent used during the attachment	Iodine, Cicatrin	\N	optional
214	attachment	float_additional	Specify any additional flotation used	\N	Float might be added to archival tags for external use.	optional
215	attachment	release_forced	If a mechanical release is engaged at depth (too avoid crushing the tag), specify the mechanism and depth at which the release is engaged.	Wildlife Computers RD1800	\N	optional
300	deployment	geospatial_lat_start	Latitude (decimal degree) of release/ deployment	\N	\N	required
301	deployment	geospatial_lon_start	Longitude (decimal degree) of release/ deployment	\N	\N	required
302	deployment	person_tagger_capture	Person responsible for tagging or surgery	\N	Can be the name of vet, observer, crew, spear fisherman or scientist	required
303	deployment	time_coverage_start	Local date time (yyyy-mm-dd hh:mm:ss) of release/ deployment	2017-07-11T18:24:23+00:00	http://en.wikipedia.org/wiki/ISO_8601	required
304	deployment	location_capture	Name or standard identifer of location	\N	\N	recommended
...
307	deployment	cruise_capture	Name or standard identifier of cruise	\N	\N	optional
308	deployment	depth_m_capture	Depth (meters) at which the animal was caught	\N	Can use estimated depth from hook number on longline	optional
309	deployment	flag_capture	The vesselÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s country of registration	\N	\N	optional
310	deployment	hook_capture	Type of hook used	18/0 circle	Use brand name and/ product when possible.	optional
311	deployment	method_aboard	How was animal put aboard the vessel	net, sling, lifted	\N	optional
312	deployment	othertags_capture	List tag IDs for conventional, acoustic, PIT, band or satellite tags for multi-tagged situation, photoID, photo/video footage file names	Hallprint PAR007007	\N	optional
313	deployment	person_angler_capture	Person responsible for angling	\N	\N	optional
...
315	deployment	seastate_capture	World Meteorological Organization sea state code (0-9)	\N	Similar to Douglas Sea Scale 	optional
316	deployment	set_float_capture	If caught on longline, include set number and float number	\N	It''s very unlikely to tag turtle, bird/ mammal off longline.	optional
317	deployment	station_capture	Name or standard identifier of station	\N	\N	optional
318	deployment	temp_degC_capture	Air or sea surface temperature (Celsius) when the animal was caught	\N	\N	optional
319	deployment	vessel_capture	Name or standard identifier of vessel	\N	\N	optional
320	deployment	wind_knots_capture	Wind speed (knots) when the animal was caught	\N	\N	optional
...
401	animal	length_capture	Length of the animal	300	\N	required
...
405	animal	platform	Common name(s) or FAO code for species name	\N	Refer to www.itis.gov or FAO species list	required
406	animal	taxonomic_serial_number	Taxonomic Serial Number (TSN) from Integrated Taxonomic Information System	\N	https://www.itis.gov	required
500	animal	condition_recapture	Description of condition/ injury. Or specify scoring system and a score.	\N	Can be generic: good, bad, gut hooked, eye hooked, bleeding. Scoring system fof fish/ shark:  reflex action mortality predictor (RAMP), Kerstetter''s lab ACES.  Measurement: Bioelectrical Impedance Analysis (BIA) gives phase angle and composition index. Fat: Distell Fatmeter	recommended
501	animal	fate_recapture	Fate of the animal upon recapture	harvested, released, tag and release, missing, unknown; observed/ photo ID	\N	recommended
...
503	animal	length_recapture	Length of the animal	\N	\N	recommended
504	animal	length_type_recapture	Type of length measurement	SFL, CFL, TL, etcÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦	May need to compile a list of types and abbreviations	recommended
505	animal	length_unit_recapture	Unit of length measurement	\N	May need to compile a list of types and abbreviations	recommended
407	animal	lifestage_capture	Life stage of the animal	adult, juvenile, subadult, weaner	\N	recommended
506	animal	lifestage_recapture	Life stage of the animal	\N	\N	recommended
408	animal	tag_placement	Description of where the tag was placed.	second dorsal fin	\N	recommended
...
409	animal	hours_soaktime_capture	If caught on longline, specify soak time In hours	\N	\N	optional
508	animal	hours_soaktime_recapture	If caught on longline, specify soak time In hours	\N	\N	optional
410	animal	implant_numsuture	Number of suture used to close the wound	\N	Internal archival only	optional
411	animal	minutes_fighttime_capture	If caught on rod and wheel or handline, specify fight time	\N	\N	optional
509	animal	minutes_fighttime_recapture	If caught on rod and wheel or handline, specify fight time	\N	\N	optional
412	animal	minutes_operation	Time used (minutes) in carrying out the attachment or surgical procedure.	\N	\N	optional
413	animal	minutes_revival	If the animal is revived, specify revival time in minutes	\N	Can be time used in swimming the animal before release	optional
414	animal	mount_numbolts	Number of bolts used for mounting	\N	\N	optional
415	animal	sex	Sex of the animal	male, female, unknown	Likely only applicable to sharks upon visual confirmation	optional
416	animal	stock	Stock origin if known	East, West, unknown etc.	\N	optional
...
510	animal	tissue_sample_recapture	List other sample types and sample IDs if collected	\N	Tissue can be any issue: fin clip, blood, scale, hard parts, stomach, muscle, biopsy etc.	optional
418	animal	weight_capture	Weight of the animal	1200	\N	optional
...
512	animal	weight_recapture	Weight of the animal	\N	\N	optional
...
513	animal	weight_type_recapture	Type of weight measurement	\N	May need to compile a list of types and abbreviations: whole, dressed, gilled & gutted	optional
421	animal	weight_unit_capture	Unit of weight measurement	pound	\N	optional
514	animal	weight_unit_recapture	Unit of weight measurement	\N	\N	optional
600	end_of_mission	time_coverage_end	End date time (yyyy-mm-dd hh:mm:ss) or date range (BETWEEN yyyy-mm-dd AND yyyy-mm-dd) if estimated/ guessed.	2017-07-11T18:24:23+00:00	http://en.wikipedia.org/wiki/ISO_8601	required
601	end_of_mission	end_details	TODO	GPS, Argos, estimated, calculated, modeled, recovered on animal, floater at sea, animal died and sank, recovered on land, recovered by fishing fleet, recovered in port, transfer in transshipment, found in well number X, recovered in processing plant	\N	required
602	end_of_mission	end_type	Description of how the end point is derived for the device.	first reported, recaptured, last transmission, recovered	\N	required
603	end_of_mission	geospatial_lat_end	End latitude	\N	\N	required
604	end_of_mission	geospatial_lon_end	End longitude	\N	\N	required
605	end_of_mission	locationclass_end	Argos location class for popup location or satellite transmission	\N	\N	recommended
606	end_of_mission	datetime_death	If mortality occurs before end datetime, specify date time (yyyy-mm-dd hh:mm:ss)	2017-07-11T18:24:23+00:00	http://en.wikipedia.org/wiki/ISO_8601	optional
700	recovery	location_recapture	Name or standard identifier of location	\N	\N	recommended
701	recovery	method_recapture	Type of gear used to catch the animal	Longline, purse seine, troll, trawl, rod and reel, handline, set net, trap, gillnet, harpoon, hoop net, anesthesia, tangle net, dip net, vertical line entanglement (commercial fisheries, aquaculture, mooring), dredge, pound net/weir (for turtles)	\N	recommended
702	recovery	person_recapture	Person responsible for the recapture	\N	Name of angler, observer, scientist, fisher, beach comber etc.	recommended
703	recovery	baitlure_recapture	Bait, chum, lure or decoy used	\N	Use brand name and/ product when possible	optional
704	recovery	cruise_recapture	Name or standard identifier of cruise	\N	\N	optional
705	recovery	depth_m_recapture	Depth (meters) at which the animal was caught	\N	Can use estimated depth from hook number on longline	optional
706	recovery	flag_capture	The vesselÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s country of registration	\N	\N	optional
707	recovery	hook_recapture	Type of hook used	\N	Use brand name and/ product when possible.	optional
708	recovery	person_tagger_recapture	Person responsible for tag-and-release	\N	Very unlikely to re-tag turtle or mammal	optional
709	recovery	retagged_recapture	List tag IDs for conventional, acoustic, PIT, band or satellite tags for multi-tagged situation, photoID, photo/video footage file names	\N	\N	optional
...
711	recovery	seastate_recapture	World Meteorological Organization sea state code (0-9)	\N	Similar to Douglas Sea Scale 	optional
712	recovery	set_float_recapture	If caught on longline, include set number and float number	\N	\N	optional
713	recovery	station_recapture	Name or standard identifier of station	\N	\N	optional
714	recovery	temp_degC_recapture	Air or sea surface temperature (Celsius) when the animal was caught	\N	\N	optional
715	recovery	vessel_recapture	Name or standard identifier of vessel	\N	\N	optional
716	recovery	wind_knots_recapture	Wind speed (knots) when the animal was caught	\N	\N	optional
1000	waypoints	waypoints_source	State the source for waypoints	Argos, GPS, acoustic detections, manufacturer, modeled	Waypoints are 'points'" along the trajectory of the tagged animal between the start and end dates."	required
...
1002	waypoints	interpolation_method	None if no interpolation. Otherwise, specify method/ software used.	None, crawl, BÃƒÆ’Ã‚Â©zier curves, Hermite splines and cubic splines	\N	recommended
1003	waypoints	interpolation_time	Specify the time interval for interpolation	0, 1 hour, gap filling	Use 0 for no interpolation or gap filling for data points without any coordinates.	recommended
1004	waypoints	waypoints_method	If 'waypoints_source'" = '"modeled'"	 specify the method used to estimate the positions. Include citation/ reference/ url if available"	kftrack, ukfsst, trackit, tripEstimation, SSM, GPE3, Track & Loc, GeoLight, BASTrack, IKNOS	recommended
1005	waypoints	waypoints_software	Software packages used with version number	\N	\N	recommended
1006	waypoints	geolocation_output	URL/URI to any relevant geocorrection output file(s) produced	eg. ftp://myserver/myfiles.zip	\N	optional
...
1101	ancillary_positions	ancillary_position_instrumentid	List chronologically the instruments collecting the ancillary position(s)	receiverID1003, receiverID1008, receiverID1121	\N	optional
1102	ancillary_positions	datetime_ancillary_position	List chronologically the datetime (yyyy-mm-dd hh:mm:ss) for ancillary position(s)	2016-01-04 22:32:21, 2016-02-01 02:41:11, 2016-03-29 09:15:31	http://en.wikipedia.org/wiki/ISO_8601	optional
1103	ancillary_positions	ancillary_position_lon	List chronologically the longitude for ancillary position(s)	-153.42,-152.42,-152.49	\N	optional
1104	ancillary_positions	ancillary_position_lat	List chronologically the latitude for ancillary position(s)	42.131,41.135,42.422	\N	optional
...
1200	quality	found_problem	Is there any problem found in this dataset? One of 3 responses: yes, no, unexamined.	yes	\N	required
1201	quality	person_qc	Person responsible for quality control	\N	\N	required
1202	quality	problem_affecteddates	Date range (BETWEEN yyyy-mm-dd AND yyyy-mm-dd) in which data quality is in doubt	\N	\N	recommended
1203	quality	problem_details	Provide details for the problem(s)	Daily drift after sunset by 1.5 degC	\N	recommended
...
1205	quality	problem_summary	List short description(s) for the problem(s)	Temperature sensor drift	\N	recommended
1206	quality	calibration_file	Files/ URLs used for calibration of sensors	\N	\N	optional
\.
